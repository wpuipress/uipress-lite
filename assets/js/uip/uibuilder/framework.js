...
export default {
  components: {
    layersPanels: defineAsyncComponent(() => import("./layers.min.js?ver=3.3.094")),
    blockcontextmenu: defineAsyncComponent(() => import("./block-contextmenu.min.js?ver=3.3.094")),
    ToolBar: defineAsyncComponent(() => import("./toolbar.min.js?ver=3.3.094")),
    Canvas: defineAsyncComponent(() => import("./canvas.min.js?ver=3.3.094")),
    BlockList: defineAsyncComponent(() => import("./block-list.min.js?ver=3.3.094")),
    TemplateLibrary: defineAsyncComponent(() => import("./template-library.min.js?ver=3.3.094")),
    DynamicData: defineAsyncComponent(() => import("./dynamic-data-watcher.min.js?ver=3.3.094")),
  },
