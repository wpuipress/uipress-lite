  ...
  template: `
    ...
    <div class="uip-flex uip-flex-column uip-row-gap-xs">
        ...
        <div class="uip-grid-col-1-3">
          ...
          <div class="uip-text-muted uip-flex uip-flex-center uip-text-s"><span>{{strings.grow}}</span></div>
        ...
        <div class="uip-grid-col-1-3">
          ...
          <div class="uip-text-muted uip-flex uip-flex-center uip-text-s"><span>{{strings.height}}</span></div>
        ...
        <div v-if="option.enabled.flexShrink" class="uip-grid-col-1-3">
          ...
          <div class="uip-text-muted uip-flex uip-flex-center uip-text-s"><span>{{strings.flexShrink}}</span></div>
