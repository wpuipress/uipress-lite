...
export default {
  ...
  components: {
    ...
    backgroundFill: defineAsyncComponent(() => import("./background-fill.min.js?ver=3.3.08")),
    screenControl: defineAsyncComponent(() => import("../v3.5/utility/screen-control.min.js?ver=3.3.08")),
    ColorPicker: defineAsyncComponent(() => import("../v3.5/styles/color-picker.min.js?ver=3.3.08")),
    colourStyleEditor: defineAsyncComponent(() => import("../v3.5/styles/color-style-editor.min.js?ver=3.3.08")),
    imageBGSelect: defineAsyncComponent(() => import("../v3.5/styles/image-select.min.js?ver=3.3.08")),
    borderDesigner: defineAsyncComponent(() => import("./border-designer.min.js?ver=3.3.08")),
    shadowDesigner: defineAsyncComponent(() => import("./shadow-designer.min.js?ver=3.3.08")),
    outlineDesigner: defineAsyncComponent(() => import("./outline-designer.min.js?ver=3.3.08")),
  },
  props: {
    value: Object,
  },
