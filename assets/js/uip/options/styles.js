...
export default {
  ...
  components: {
    ...
    backgroundFill: defineAsyncComponent(() => import("./background-fill.min.js?ver=3.3.094")),
    ...
    imageBGSelect: defineAsyncComponent(() => import("../v3.5/styles/image-select.min.js?ver=3.3.094")),
    borderDesigner: defineAsyncComponent(() => import("./border-designer.min.js?ver=3.3.094")),
    shadowDesigner: defineAsyncComponent(() => import("./shadow-designer.min.js?ver=3.3.094")),
    outlineDesigner: defineAsyncComponent(() => import("./outline-designer.min.js?ver=3.3.094")),
  },
  props: {
    value: Object,
  },
