...
export default {
  ...
  components: {
    ...
    backgroundFill: defineAsyncComponent(() => import('./background-fill.min.js?ver=3.2.12')),
    ...
    borderDesigner: defineAsyncComponent(() => import('./border-designer.min.js?ver=3.2.12')),
    shadowDesigner: defineAsyncComponent(() => import('./shadow-designer.min.js?ver=3.2.12')),
    outlineDesigner: defineAsyncComponent(() => import('./outline-designer.min.js?ver=3.2.12')),
  },
  props: {
    value: Object,
  },
