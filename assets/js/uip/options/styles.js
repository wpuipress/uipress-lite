...
export default {
  umits: ["update"],
  components: {
    colorBox: defineAsyncComponent(() => import("../v3.5/utility/color-box.min.js?ver=3.3.09")),
    backgroundFill: defineAsyncComponent(() => import("./background-fill.min.js?ver=3.3.09")),
    screenControl: defineAsyncComponent(() => import("../v3.5/utility/screen-control.min.js?ver=3.3.09")),
    ColorPicker: defineAsyncComponent(() => import("../v3.5/styles/color-picker.min.js?ver=3.3.09")),
    colourStyleEditor: defineAsyncComponent(() => import("../v3.5/styles/color-style-editor.min.js?ver=3.3.09")),
    imageBGSelect: defineAsyncComponent(() => import("../v3.5/styles/image-select.min.js?ver=3.3.09")),
    borderDesigner: defineAsyncComponent(() => import("./border-designer.min.js?ver=3.3.09")),
    shadowDesigner: defineAsyncComponent(() => import("./shadow-designer.min.js?ver=3.3.09")),
    outlineDesigner: defineAsyncComponent(() => import("./outline-designer.min.js?ver=3.3.09")),
  },
  props: {
    value: Object,
  },
