  ...
  methods: {
    ...
    formatInput() {
      ...
      if ('color' in this.value) {
        this.option.color = { ...this.option.color, ...this.value.color };
      }
      if ('size' in this.value) {
        this.option.size = { ...this.option.size, ...this.value.size };
      }
      if ('lineHeight' in this.value) {
        this.option.lineHeight = { ...this.option.lineHeight, ...this.value.lineHeight };
      }
    },
  },
  template: `
