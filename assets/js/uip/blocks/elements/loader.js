...
const Paragraph = {
  ...
  optionsEnabled: [
    //Block options group
    {
      ...
      label: __('Block options', 'uipress-lite'),
      icon: 'check_box_outline_blank',
      options: [{ option: 'paragraph', componentName: 'uip-paragraph-input', label: __('Content', 'uipress-lite'), args: { fullWidth: true } }],
    },
...
const Video = {
  ...
  optionsEnabled: [
    //Block options group
    {
      ...
      icon: 'check_box_outline_blank',
      options: [
        { option: 'textField', componentName: 'uip-input', uniqueKey: 'videoURL', label: __('Video URL', 'uipress-lite'), value: 'https://www.youtube.com/embed/ZgCY96vPUGI' },
