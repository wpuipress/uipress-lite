        ...
        return (
          (r =
            e < 66
              ...
              : ((n = 351.97690566805693 + 0.114206453784165 * (n = e - 55) - 40.25366309332127 * q(n)), (i = 325.4494125711974 + 0.07943456536662342 * (i = e - 50) - 28.0852963507957 * q(i)), 255)),
        ...
        },
        {
          ...
          set: function (t) {
            var n,
              ...
              u = 1;
            if (
              ((n = _.exec(t)) ? ((i = K(n[1], 255)), (r = K(n[2], 255)), (e = K(n[3], 255))) : (n = H.exec(t)) && ((i = K(n[1], 255)), (r = K(n[2], 255)), (e = K(n[3], 255)), (u = K(n[4], 1))), !n)
            )
        ...
        },
        {
          ...
          set: function (t) {
            var n,
              ...
              u = 1;
            if (
              ((n = P.exec(t)) ? ((i = K(n[1], 360)), (r = K(n[2], 100)), (e = K(n[3], 100))) : (n = $.exec(t)) && ((i = K(n[1], 360)), (r = K(n[2], 100)), (e = K(n[3], 100)), (u = K(n[4], 1))), !n)
            )
      ...
      function (t, n, i) {
        return h(
          ...
          Object.assign({}, n, {
            ...
            style: Object.assign(
              {},
              { position: "relative", width: vt(r), height: vt(o), borderRadius: vt(l), background: "conic-gradient(#ccc 25%, #fff 0 50%, #ccc 0 75%, #fff 0)", backgroundSize: "8px 8px" },
              i
            ),
          }),
          h("div", {
            ...
            style: Object.assign(
              {},
              { position: "absolute", top: 0, left: 0, width: "100%", height: "100%", borderRadius: vt(l), background: ht("linear", "horizontal" === e.layoutDirection ? "to top" : "to right", c) },
              ft(e)
            ),
          }),
    ...
    return h(
      ...
      function (t, n, i) {
        return h(
          ...
          h("div", {
            className: "IroBox",
            style: Object.assign({}, { width: "100%", height: "100%", borderRadius: vt(o) }, ft(e), { background: ht("linear", "to bottom", a[1]) + "," + ht("linear", "to right", a[0]) }),
          }),
          l
            .filter(function (t) {
              return t !== c;
            ...
            .map(function (t) {
              return h(bt, { isActive: !1, index: t.index, fill: t.hslString, r: e.handleRadius, url: e.handleSvg, props: e.handleProps, x: f[t.index].x, y: f[t.index].y });
            }),
          h(bt, { isActive: !0, index: c.index, fill: c.hslString, r: e.activeHandleRadius || e.handleRadius, url: e.handleSvg, props: e.handleProps, x: f[c.index].x, y: f[c.index].y })
        );
      }
    );
  }
      ...
      function (t, n, i) {
        return h(
          ...
          u
            ...
            .map(function (t) {
              return h(bt, { isActive: !1, index: t.index, fill: t.hslString, r: e.handleRadius, url: e.handleSvg, props: e.handleProps, x: c[t.index].x, y: c[t.index].y });
            }),
          h(bt, { isActive: !0, index: l.index, fill: l.hslString, r: e.activeHandleRadius || e.handleRadius, url: e.handleSvg, props: e.handleProps, x: c[l.index].x, y: c[l.index].y })
        );
      }
    );
  }
