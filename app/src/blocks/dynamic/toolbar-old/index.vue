...
import { toolbarnode, toolbarMenu, setToolbar } from "./src/setToolbar.js";
...
<template>
  <div class="" v-if="1 == 1">
    <ul class="flex flex-row gap-5 items-center" ref="toolbarnode" id="wpadminbar"></ul>
  ...
  <div id="wpadminbar" style="display: block !important" class="uip-text-normal" v-else-if="rendered && 1 == 2">
