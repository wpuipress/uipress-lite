...
<template>
  <div class="uip-flex uip-flex-column uip-row-gap-xs">
    ...
    <div class="uip-grid-col-1-3">
      ...
      <div class="uip-flex uip-flex-row uip-gap-xxxs">
        ...
        <div class="uip-background-muted uip-border-rounder uip-flex uip-flex-grow">
          <units-select
            :value="option.offset.units"
            :returnData="
              function (e) {
                option.offset.units = e;
              }
            "
          ></units-select>
        </div>
    ...
    <div class="uip-grid-col-1-3">
      <div class="uip-text-muted uip-flex uip-flex-center uip-text-s">
        <span>{{ strings.verticalAlign }}</span>
      </div>

      <div class="uip-flex uip-gap-xs uip-flex-no-wrap uip-flex-center">
        <toggle-switch
          :options="verticalAlignOptions"
          :activeValue="option.verticalAlign"
          :returnValue="
            function (data) {
              option.verticalAlign = data;
            }
          "
        ></toggle-switch>
      </div>
    ...
    <div class="uip-grid-col-1-3">
      <div class="uip-text-muted uip-flex uip-flex-center uip-text-s">
        <span>{{ strings.horizontalAlign }}</span>
      </div>

      <div class="uip-flex uip-gap-xs uip-flex-no-wrap uip-flex-center">
        <toggle-switch
          :options="horizontalAlignOptions"
          :activeValue="option.horizontalAlign"
          :returnValue="
            function (data) {
              option.horizontalAlign = data;
            }
          "
        ></toggle-switch>
      </div>
