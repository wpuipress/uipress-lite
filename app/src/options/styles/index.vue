...
import imageBGSelect from "@/components/image-select/index.vue";

import backgroundFill from "@/options/background-fill/index.vue";
import borderDesigner from "@/options/border-designer/index.vue";
import shadowDesigner from "@/options/shadow-designer/index.vue";
import outlineDesigner from "@/options/outline-designer/index.vue";
