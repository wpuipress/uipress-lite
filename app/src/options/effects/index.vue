...
import BlendModes from "@/data/mix_blend_modes.js";
import TransitionTypes from "@/data/css_transitions.js";
import CursorTypes from "@/data/cursor_types.js";
import CursorTypesResize from "@/data/cursor_resize_types.js";
...
<template>
  <div class="uip-flex uip-flex-column uip-row-gap-s">
          ...
          <template #content>
            <div class="uip-flex uip-flex-column uip-row-gap-s uip-padding-s uip-w-240">
              ...
              <div class="uip-grid-col-1-3 uip-padding-left-xs">
                <div class="uip-text-muted uip-flex uip-flex-center uip-text-s">
                  <span>{{ strings.translate }} X</span>
                </div>

                <value-units
                  :value="options.transform.translateX"
                  :returnData="
                    function (data) {
                      options.transform.translateX = data;
                    }
                  "
                />
                ...
                <div class="uip-text-muted uip-flex uip-flex-center uip-text-s">
                  <span>{{ strings.translate }} Y</span>
                </div>

                <value-units
                  :value="options.transform.translateY"
                  :returnData="
                    function (data) {
                      options.transform.translateY = data;
                    }
                  "
                />
                ...
                <div class="uip-text-muted uip-flex uip-flex-center uip-text-s">
                  <span>{{ strings.scale }} X</span>
                </div>
                <uip-number
                  :value="options.transform.scaleX"
                  :returnData="
                    (d) => {
                      options.transform.scaleX = d;
                    }
                  "
                  placeHolder=""
                  :step="0.1"
                ...
                <div class="uip-text-muted uip-flex uip-flex-center uip-text-s">
                  <span>{{ strings.scale }} Y</span>
                </div>
                <uip-number
                  :value="options.transform.scaleY"
                  :returnData="
                    (d) => {
                      options.transform.scaleY = d;
                    }
                  "
                  placeHolder=""
                  :step="0.1"
          ...
          <template #content>
            <div class="uip-flex uip-flex-column uip-row-gap-s uip-padding-s uip-w-240">
              ...
              <div class="uip-grid-col-1-3 uip-padding-left-xs">
                ...
                <div class="uip-text-muted uip-flex uip-flex-center uip-text-s">
                  <span>{{ strings.mixBlendMode }}</span>
                </div>
                ...
                <div class="uip-position-relative">
                  <select
                    ...
                    v-model="options.filters.mixBlendMode"
                  >
                ...
                <div class="uip-text-muted uip-flex uip-flex-center uip-text-s">
                  <span>{{ strings.grayscale }}</span>
                </div>
                <uip-number
                  :value="options.filters.grayscale"
                  :returnData="
                    (d) => {
                      options.filters.grayscale = d;
                    }
                  "
                  placeHolder=""
                  :step="0.1"
                ...
                <div class="uip-flex uip-gap-xs uip-flex-no-wrap uip-flex-center">
                  <input
                    ...
                    min="0"
                    max="100"
                    class="uip-input uip-padding-xxxs uip-w-60 uip-border-rounder"
                    style="border-radius: var(--uip-border-radius-large)"
                    v-model="options.filters.blur"
                  />
                ...
                <div class="uip-text-muted uip-flex uip-flex-center uip-text-s">
                  <span>{{ strings.backdropBlur }} (px)</span>
                </div>
                ...
                <div class="uip-flex uip-gap-xs uip-flex-no-wrap uip-flex-center">
                  <input
                    ...
                    class="uip-input uip-padding-xxxs uip-w-60 uip-border-rounder"
                    style="border-radius: var(--uip-border-radius-large)"
                    v-model="options.filters.backdropBlur"
                  />
                ...
                <div class="uip-text-muted uip-flex uip-flex-center uip-text-s">
                  <span>{{ strings.saturate }}</span>
                </div>
                <uip-number
                  :value="options.filters.saturate"
                  :returnData="
                    (d) => {
                      options.filters.saturate = d;
                    }
                  "
                  placeHolder=""
                  :step="0.1"
                ...
                <div class="uip-text-muted uip-flex uip-flex-center uip-text-s">
                  <span>{{ strings.contrast }}</span>
                </div>
                <uip-number
                  :value="options.filters.contrast"
                  :returnData="
                    (d) => {
                      options.filters.contrast = d;
                    }
                  "
                  placeHolder=""
                  :step="0.1"
    ...
    <div class="uip-grid-col-1-3">
      <div class="uip-text-muted uip-flex uip-flex-center uip-text-s">
        <span>{{ strings.transitionType }}</span>
      </div>
      ...
      <div class="uip-flex uip-gap-xs uip-flex-no-wrap uip-flex-center">
        <select
          class="uip-input-small uip-padding-top-xxxs uip-padding-bottom-xxxs uip-max-w-100p uip-w-100p uip-border-rounder"
          style="padding-top: 2px; padding-bottom: 2px; border-radius: var(--uip-border-radius-large)"
          v-model="options.transitionType"
        >
    ...
    <div class="uip-grid-col-1-3">
      <div class="uip-text-muted uip-flex uip-flex-center uip-text-s">
        <span>{{ strings.transitionTime }}</span>
      </div>
      <uip-number
        :value="options.transitionTime"
        :returnData="
          (d) => {
            options.transitionTime = d;
          }
        "
        placeHolder=""
        :step="0.1"
    ...
    <div class="uip-grid-col-1-3">
      <div class="uip-text-muted uip-flex uip-flex-center uip-text-s">
        <span>{{ strings.transitionDelay }}</span>
      </div>
      <uip-number
        :value="options.transitionDelay"
        :returnData="
          (d) => {
            options.transitionDelay = d;
          }
        "
        placeHolder=""
        :step="0.1"
