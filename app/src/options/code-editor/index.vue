...
<template>
  <div class="uip-w-100p">
    <component is="style">
      .ace-xcode .ace_gutter{background:transparent;} .ace_gutter-cell{color:var(--uip-text-color-muted);opacity:0.6} .ace-xcode .ace_gutter-active-line { background:transparent; color:
      var(--uip-text-color-emphasis); font-weight: bolder; opacity:1; } .ace_scrollbar { display: none; } .ace_editor:hover .ace_scrollbar { display: block; } .ace_editor {background:transparent}
