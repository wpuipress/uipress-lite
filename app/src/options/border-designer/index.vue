...
import BorderPositions from "@/data/border_positions.js";
import BorderTypes from "@/data/border_types.js";
...
<template>
  <div class="uip-flex uip-flex-column uip-row-gap-xs uip-padding-left-xs">
    ...
    <div class="uip-grid-col-1-3">
      ...
      <colorBox
        @click="$emit('request-screen', returnFillScreen)"
        :backgroundStyle="returnBorderColor"
        :text="borderOptions.color.value"
        :remove="
          () => {
            borderOptions.color.value = '';
          }
        "
      />
    </div>
    ...
    <div class="uip-grid-col-1-3">
      ...
      <div class="uip-flex uip-gap-xs uip-flex-no-wrap uip-flex-center">
        <toggle-switch
          :options="borderPositions"
          :activeValue="borderOptions.position"
          :returnValue="
            function (data) {
              borderOptions.position = data;
            }
          "
        ></toggle-switch>
      </div>
      ...
      <div class="uip-flex uip-gap-xs uip-flex-no-wrap uip-flex-right uip-flex-column uip-row-gap-xs">
        <div class="uip-flex uip-flex-row uip-gap-xxxs uip-flex-right">
          ...
          <div class="uip-background-muted uip-border-round">
            <units-select
              :value="borderOptions.radius.value.units"
              :returnData="
                function (e) {
                  borderOptions.radius.value.units = e;
                }
              "
            ></units-select>
          </div>
