        ...
        <template v-slot:trigger>
          <div class="uip-grid-col-1-3">
            <div class="uip-text-muted uip-flex uip-flex-center uip-text-s">
              <span>{{ returnInteractionNiceName(element.type) }}</span>
            </div>
          ...
          <div class="uip-padding-s uip-flex uip-flex-column uip-row-gap-s">
            ...
            <div class="uip-grid-col-1-3">
              ...
              <template v-if="element.target == 'block'">
                <div class="uip-text-muted uip-flex uip-flex-center uip-text-s">
                  <span>{{ strings.block }}</span>
                </div>
                <div class="uip-flex uip-flex-center uip-gap-xxs">
                  <dropdown pos="bottom right" class="uip-flex uip-w-100p" :ref="'blocksearch_' + index">
                    <template #trigger>
                      <div
                        class="uip-padding-xxs uip-padding-left-xs uip-border-rounder uip-text-s uip-background-muted uip-flex-grow uip-text-ellipsis uip-no-wrap uip-overflow-hidden uip-max-w-160 uip-flex uip-gap-xxxs uip-flex-center"
                      >
                      ...
                      <div class="uip-w-260 uip-padding-s uip-flex uip-flex-column uip-row-gap-xs">
                        ...
                        <div class="uip-flex uip-flex-column uip-max-h-300 uip-overflow-auto">
                          <template v-for="block in uiTemplate.blockRefs">
                            <div
                              v-if="blockInSearch(block)"
                              @click="
                                element.blockTarget = block.uid;
                                $refs['blocksearch_' + index][0].close();
                              "
