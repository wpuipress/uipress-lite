...
<template>
  <div
    class="uip-position-fixed uip-top-80 uip-right-16 uip-bottom-16 uip-background-default uip-w-320 uip-flex uip-flex-column uip-row-gap-s uip-overflow-auto uip-fade-in uip-shadow"
    style="border-radius: calc(var(--uip-border-radius-large) + var(--uip-padding-xs)); z-index: 2"
          ...
          <div class="uip-flex uip-flex-column uip-row-gap-s">
            ...
            <div class="uip-grid-col-1-3">
              ...
              <toggle-switch
                ...
                :activeValue="uiTemplate.globalSettings.status"
                :dontAccentActive="true"
                :returnValue="
                  function (data) {
                    uiTemplate.globalSettings.status = data;
                  }
                "
              />
              ...
              <template v-if="uipApp.data.options.multisite && uipApp.data.options.networkActivated && uipApp.data.options.primarySite">
                ...
                <toggle-switch
                  :options="enabledDisabled"
                  :activeValue="uiTemplate.globalSettings.applyToSubsites"
                  :dontAccentActive="true"
                  :returnValue="
                    function (data) {
                      uiTemplate.globalSettings.applyToSubsites = data;
                    }
                  "
                ></toggle-switch>
              </template>
              ...
              <user-role-select
                :selected="uiTemplate.globalSettings.rolesAndUsers"
                :placeHolder="ui.strings.selectUsersAndRoles"
                :searchPlaceHolder="ui.strings.searchUsersAndRoles"
                :single="false"
                :updateSelected="(d) => (uiTemplate.globalSettings.rolesAndUsers = d)"
              ></user-role-select>
              ...
              <user-role-select
                :selected="uiTemplate.globalSettings.excludesRolesAndUsers"
                :placeHolder="ui.strings.selectUsersAndRoles"
                :searchPlaceHolder="ui.strings.searchUsersAndRoles"
                :single="false"
                :updateSelected="(d) => (uiTemplate.globalSettings.excludesRolesAndUsers = d)"
              ></user-role-select>
              ...
              <template v-if="uiTemplate.globalSettings.type == 'ui-admin-page'">
                ...
                <icon-select
                  class="uip-w-100p"
                  :value="uiTemplate.globalSettings.menuIcon"
                  :returnData="
                    function (e) {
                      uiTemplate.globalSettings.menuIcon = e;
                    }
                  "
                ></icon-select>
        ...
        <template v-if="uiTemplate.globalSettings.type == 'ui-template'">
          ...
          <ToggleSection :title="ui.strings.content" :startOpen="true">
            ...
            <div class="uip-grid-col-1-3">
              ...
              <toggle-switch
                :options="enabledDisabled"
                :activeValue="uiTemplate.globalSettings.contentTheme"
                :dontAccentActive="true"
                :returnValue="
                  (data) => {
                    uiTemplate.globalSettings.contentTheme = data;
                  }
                "
              />
              ...
              <toggle-switch
                :options="showHide"
                :activeValue="uiTemplate.globalSettings.helpTab"
                :dontAccentActive="true"
                :returnValue="
                  (data) => {
                    uiTemplate.globalSettings.helpTab = data;
                  }
                "
              />
              ...
              <toggle-switch
                :options="showHide"
                :activeValue="uiTemplate.globalSettings.screenOptions"
                :dontAccentActive="true"
                :returnValue="
                  (data) => {
                    uiTemplate.globalSettings.screenOptions = data;
                  }
                "
              />
              ...
              <toggle-switch
                :options="showHide"
                :activeValue="uiTemplate.globalSettings.pluginNotices"
                :dontAccentActive="true"
                :returnValue="
                  (data) => {
                    uiTemplate.globalSettings.pluginNotices = data;
                  }
                "
              />
            </div>
