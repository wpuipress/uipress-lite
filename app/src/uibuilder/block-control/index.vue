...
<template>
  <!-- Hover wrap -->
  <div v-if="hoverWrapVisible && !dontDisplayWraps" class="uip-border uip-position-fixed uip-fade-in uip-no-select" :style="returnHoverWrapStyle"></div>

  <!-- Selected wrap -->
  <div v-if="wrapVisible && !dontDisplayWraps" class="uip-border uip-position-fixed uip-fade-in uip-no-select" :style="returnWrapStyle"></div>
