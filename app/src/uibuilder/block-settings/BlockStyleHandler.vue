...
import Dimensions from "@/options/dimensions/index.vue";
import Styles from "@/options/styles/index.vue";
import Spacing from "@/options/spacing/index.vue";
import TextFormat from "@/options/text-format/index.vue";
import PositionDesigner from "@/options/position-designer/index.vue";
import EffectsDesigner from "@/options/effects/index.vue";
