...
function getConsole() {
  return "undefined" != typeof window ? window.console : global.console;
}
...
function insertNodeAt(e, t, n) {
  const o = 0 === n ? e.children[0] : e.children[n - 1].nextSibling;
  e.insertBefore(t, o);
}
function computeVmIndex(e, t) {
  return Object.values(e).indexOf(t);
}
function computeIndexes(e, t, n, o) {
  if (!e) return [];
  const i = Object.values(e),
    s = t.length - o;
  return [...t].map((e, t) => (t >= s ? i.length : i.indexOf(e)));
}
function emit(e, t) {
  this.$nextTick(() => this.$emit(e.toLowerCase(), t));
}
function delegateAndEmit(e) {
  return (t) => {
    null !== this.realList && this["onDrag" + e](t), emit.call(this, e, t);
  };
}
function isTransitionName(e) {
  return ["transition-group", "TransitionGroup"].includes(e);
}
function isTransition(e) {
  if (!e || 1 !== e.length) return !1;
  const [{ type: t }] = e;
  return !!t && isTransitionName(t.name);
}
function getComponentAttributes(e, t) {
  return t ? Object.assign(Object.assign({}, t.props), t.attrs) : e;
}
const eventsListened = ["Start", "Add", "Remove", "Update", "End"],
  eventsToEmit = ["Choose", "Unchoose", "Sort", "Filter", "Clone"],
  readonlyProperties = ["Move", ...eventsListened, ...eventsToEmit].map((e) => "on" + e);
...
export const VueDraggableNext = defineComponent({
  ...
  inheritAttrs: !1,
  emits: ["update:modelValue", "move", "change", ...eventsListened.map((e) => e.toLowerCase()), ...eventsToEmit.map((e) => e.toLowerCase())],
  props: props,
  data: () => ({ transitionMode: !1, noneFunctionalComponentMode: !1, headerOffset: 0, footerOffset: 0, _sortable: {}, visibleIndexes: [], context: {} }),
  render() {
    const e = this.$slots.default ? this.$slots.default() : null,
      t = getComponentAttributes(this.$attrs, this.componentData);
    return e ? ((this.transitionMode = isTransition(e)), h(this.getTag(), t, e)) : h(this.getTag(), t, []);
  },
  created() {
    null !== this.list && null !== this.modelValue && console.error("list props are mutually exclusive! Please set one.");
  },
  mounted() {
    const e = {};
    eventsListened.forEach((t) => {
      e["on" + t] = delegateAndEmit.call(this, t);
    }),
      eventsToEmit.forEach((t) => {
        e["on" + t] = emit.bind(this, t);
      });
    const t = Object.keys(this.$attrs).reduce((e, t) => ((e[camelize(t)] = this.$attrs[t]), e), {}),
      n = Object.assign({}, t, e, { onMove: (e, t) => this.onDragMove(e, t) });
    !("draggable" in n) && (n.draggable = ">*");
    const o = 1 === this.$el.nodeType ? this.$el : this.$el.parentElement;
    (this._sortable = new Sortable(o, n)), (o.__draggable_component__ = this), this.computeIndexes();
  },
  beforeUnmount() {
    try {
  ...
  methods: {
    ...
    updateOptions(e) {
      for (var t in e) {
        const n = camelize(t);
        -1 === readonlyProperties.indexOf(n) && this._sortable.option(n, e[t]);
      }
    },
    getChildrenNodes() {
    ...
    getUnderlyingVm(e) {
      const t = computeVmIndex(this.getChildrenNodes() || [], e);
    ...
    onDragStart(e) {
      (this.context = this.getUnderlyingVm(e.item)), this.context && ((e.item._underlying_vm_ = this.clone(this.context.element)), (draggingElement = e.item));
    },
    onDragAdd(e) {
    ...
    onDragRemove(e) {
      if ((insertNodeAt(this.$el, e.item, e.oldIndex), "clone" === e.pullMode)) return void removeNode(e.clone);
    ...
    onDragMove(e, t) {
      ...
      return Object.assign(i, { futureIndex: s }), n(Object.assign({}, e, { relatedContext: o, draggedContext: i }), t);
    },
    onDragEnd() {
      this.computeIndexes(), (draggingElement = null);
    },
    ...
    getRelatedContextFromMoveEvent({ to: e, related: t }) {
      ...
      if (e !== t && o && n.getUnderlyingVm) {
        const e = n.getUnderlyingVm(t);
        if (e) return Object.assign(e, i);
      }
      return i;
    },
    computeFutureIndex(e, t) {
      const n = [...t.to.children].filter((e) => "none" !== e.style.display);
      if (0 === n.length) return 0;
      const o = n.indexOf(t.related),
        i = e.component.getVmIndex(o);
      return -1 !== n.indexOf(draggingElement) || !t.willInsertAfter ? i : i + 1;
    },
  },
});
