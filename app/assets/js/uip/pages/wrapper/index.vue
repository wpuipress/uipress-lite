...
import Notify from "@/js/uip/components/notify/index.vue";
import AppMenu from "@/js/uip/components/app-menu/index.vue";
import Tips from "@/js/uip/uibuilder/tips/index.vue";
