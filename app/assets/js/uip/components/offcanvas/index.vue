...
<template>
  <div>
    ...
    <component is="style"> #wpadminbar{z-index:8;} </component>

    <div
      ref="offCanvasCover"
      v-if="open && overlayStyle != 'push'"
      class="uip-position-fixed uip-w-100p uip-top-0 uip-bottom-0 uip-text-normal uip-flex uip-fade-in"
    ...
    >
      <div class="uip-flex uip-w-100p uip-h-100p" :class="{ 'uip-flex-reverse': position == 'left' }">
        ...
        <div
          ref="offCanvasBody"
          class="uip-w-30p uip-background-default uip-padding-m uip-overflow-auto uip-border-box uip-offcanvas-panel uip-position-relative"
          :class="[{ 'uip-slide-in-right': position == 'right' }, { 'uip-slide-in-left': position == 'left' }]"
    ...
    <div
      ref="offCanvasCover"
      v-else-if="open && overlayStyle == 'push'"
      class="uip-position-fixed uip-w-100p uip-top-0 uip-bottom-0 uip-text-normal uip-flex"
