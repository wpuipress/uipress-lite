...
<template>
  <Teleport to="body">
    <div class="notification-drop uip-dark-mode uip-text-normal" id="notification-drop">
      <component is="style"> .list-enter-active, .list-leave-active { transition: all 0.5s ease; } .list-enter-from, .list-leave-to { opacity: 0 !important; transform: translateX(30px); } </component>
