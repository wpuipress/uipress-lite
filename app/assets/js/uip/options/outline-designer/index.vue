...
<template>
  <div class="uip-grid-col-1-3">
    ...
    <colorBox
      ...
      :backgroundStyle="returnOutlineColor"
      :text="outlineOptions.color.value"
      :remove="
        () => {
          outlineOptions.color = {};
        }
      "
    />
    ...
    <value-units
      :value="outlineOptions.width"
      :returnData="
        function (data) {
          outlineOptions.width = data;
        }
      "
      class="uip-w-100p"
    ></value-units>
    ...
    <value-units
      :value="outlineOptions.offset"
      :returnData="
        function (data) {
          outlineOptions.offset = data;
        }
      "
      class="uip-w-100p"
    ></value-units>
