...
import FlexDistribution from "@/js/uip/data/flex_distribution.js";
import FlexAlignContent from "@/js/uip/data/flex_align_content.js";
import FlexVerticalAlign from "@/js/uip/data/flex_vertical_align.js";
import FlexAlign from "@/js/uip/data/flex_align.js";
...
<template>
  <div class="uip-flex uip-flex-column uip-row-gap-xs">
    ...
    <template v-if="options.type == 'stack'">
      ...
      <div class="uip-grid-col-1-3">
        ...
        <div class="uip-position-relative">
          <toggle-switch
            :options="directions"
            :activeValue="options.direction"
            :returnValue="
              function (data) {
                options.direction = data;
              }
            "
          ></toggle-switch>
        </div>
      ...
      <div class="uip-grid-col-1-3">
        ...
        <toggle-switch
          :options="returnAlignOptions"
          :activeValue="options.align"
          :returnValue="
            function (data) {
              options.align = data;
            }
      ...
      <div class="uip-grid-col-1-3">
        <div class="uip-text-muted uip-flex uip-flex-center uip-text-s">
          <span>{{ strings.wrap }}</span>
        </div>

        <div class="uip-position-relative">
          <toggle-switch
            :options="flexWrap"
            :activeValue="options.wrap"
            :returnValue="
              function (data) {
                options.wrap = data;
              }
    ...
    <template v-if="options.type == 'grid'">
      ...
      <div class="uip-grid-col-1-3">
        <div class="uip-text-muted uip-flex uip-flex-center uip-text-s">
          <span>{{ strings.responsive }}</span>
        </div>

        <div class="uip-position-relative">
          <toggle-switch
            :options="responsiveOptions"
            :activeValue="options.responsive"
            :returnValue="
              function (data) {
      ...
      <div v-if="options.responsive" class="uip-grid-col-1-3">
        <div class="uip-text-muted uip-flex uip-flex-center uip-text-s">
          <span>{{ strings.minimumColumnWidth }}</span>
        </div>
