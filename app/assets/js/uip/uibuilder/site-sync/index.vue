  ...
  <Modal :startOpen="true" ref="sitesyncwrap">
    <div ref="uipmodal" class="uip-flex uip-flex-column uip-row-gap-m uip-w-400 uip-padding-m">
      ...
      <div class="uip-flex uip-flex-between uip-flex-center">
        ...
        <div
          class="uip-icon uip-link-muted uip-padding-xxs uip-border-round hover:uip-background-muted"
          @click="
            $refs.sitesyncwrap.close();
            this.$router.push('/');
          "
        >
          close
      ...
      <template v-else>
        ...
        <div class="uip-grid-col-1-3 uip-row-gap-s" style="grid-gap: var(--uip-margin-s)">
          ...
          <div class="uip-text-muted uip-flex">
            <span>{{ strings.syncOptions }}</span>
          </div>
