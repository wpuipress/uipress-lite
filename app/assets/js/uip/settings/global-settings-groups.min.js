const { __: __, _x: _x, _n: _n, _nx: _nx } = wp.i18n;
export function processGlobalGroups(e, s) {
  const t = { ...e };
  for (let [e] of Object.entries(t)) {
    const l = s.filter((s) => s.group === e),
      i = new Set();
    t[e].settings = t[e].settings || [];
    for (let s of l) {
      const l = s.group + s.uniqueKey;
      i.has(l) || (t[e].settings.push(s), i.add(l));
    }
    t[e].settings.sort((e, s) => e.order - s.order);
  }
  return ((e) => {
    let s = {};
    return (
...
export const globalSettingsGroups = {
  advanced: { label: __("Advanced", "uipress-pro"), name: "advanced", icon: "code" },
  whiteLabel: { label: __("White label", "uipress-pro"), name: "whiteLabel", icon: "branding_watermark" },
  theme: { label: __("Theme", "uipress-lite"), name: "theme", icon: "palette" },
  login: { label: __("Login", "uipress-lite"), name: "login", icon: "login" },
  postsPages: { label: __("Posts and pages", "uipress-lite"), name: "postsPages", icon: "article" },
  media: { label: __("Media", "uipress-lite"), name: "media", icon: "photo_library" },
  plugins: { label: __("Plugins", "uipress-lite"), name: "plugins", icon: "extension" },
  general: { label: __("General", "uipress-lite"), name: "general", icon: "language" },
  extensions: { label: __("Extensions", "uipress-pro"), name: "extensions", icon: "extension" },
};
export const globalSettings = [
  {
    component: "inline-image-select",
    args: { hasPositioning: !1 },
    group: "general",
  ...
  },
  {
    ...
    args: {
      options: {
        left: { value: "left", label: __("Left", "uipress-lite") },
        center: { value: "center", label: __("Center", "uipress-lite") },
        right: { value: "right", label: __("Right", "uipress-lite") },
      },
    },
  },
  {
    component: "switch-select",
    args: { asText: !0, options: { false: { value: !1, label: __("Disabled", "uipress-lite") }, true: { value: !0, label: __("Enabled", "uipress-lite") } } },
    group: "login",
  ...
  },
  {
    ...
    args: { asText: !0 },
    group: "whiteLabel",
    args: { asText: !0, options: { false: { value: !1, label: __("Show", "uipress-lite") }, true: { value: !0, label: __("Hide", "uipress-lite") } } },
  ...
  {
    component: "switch-select",
    args: { asText: !0, options: { true: { value: !0, label: __("Disabled", "uipress-lite") }, false: { value: !1, label: __("Enabled", "uipress-lite") } } },
    group: "advanced",
